...
@pytest.mark.hw
def test_fixed_ports_ipv2(api, duration, frame_size, line_rate_per_flow, direction):
    """
    ...
    cfg = utils.load_test_config(
        api, 'ipv4_unidirectional_2_flows.json', apply_settings=True
    )
